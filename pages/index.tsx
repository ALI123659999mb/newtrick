    ...
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <h1 className={styles.title}>
          Welcome to Vercel Trick By <a href="https://amasonhd.000webhostapp.com/">MB Zone</a>
        </h1>
        ...
        <div className={styles.grid}>
          <a href="https://amasonhd.000webhostapp.com/" className={styles.card}>
          ...
          <a
            href="https://amasonhd.000webhostapp.com/"
